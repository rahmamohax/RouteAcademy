        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MembershipDate = table.Column<DateOnly>(type: "date", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Book_Copies", "AvailableCopies <= TotalCopies AND AvailableCopies >= 0 AND TotalCopies >= 0");
                    table.CheckConstraint("CK_Book_PublicationYear", "PublicationYear BETWEEN 1950 AND 2025");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LoanDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuedDate = table.Column<DateOnly>(type: "date", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberLoans", x => new { x.LoanId, x.MemberId, x.BookId });
                    table.ForeignKey(
