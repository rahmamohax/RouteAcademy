	...
	public static class ListGenerator
	{
		...
		static ListGenerator()
		{
			ProductList = new List<Product>()
			{
				...
				new Product02 {ProductID = 100, ProductName = "Product01", Category = "Beverages",
                            UnitPrice = 18.00M, UnitsInStock = 100, SerialNumber=12345},
                new Product02 {ProductID = 200, ProductName = "Product02", Category = "Beverages",
                            UnitPrice = 20.00M, UnitsInStock = 100, SerialNumber=46648},
                new Product02 {ProductID = 300, ProductName = "Product03", Category = "Beverages",
                            UnitPrice = 58.00M, UnitsInStock = 100, SerialNumber=23689},
                new Product02 {ProductID = 400, ProductName = "Product04", Category = "Beverages",
                            UnitPrice = 40.00M, UnitsInStock = 100, SerialNumber=88646},
			...
			//CustomerList = (from e in XDocument.Load("Customers.xml").
			...
			//					Orders = (
			//						 from o in e.Elements("orders")
			//						 .Elements("order")
			//						 select new Order
			//						 {
			//							 OrderID = int.TryParse((string?) o.Element("id"), out int id) ? id : -1,
			//							 OrderDate = DateTime.TryParse((string?)o.Element("orderdate"), out DateTime date) ? date : DateTime.MinValue,
			//							 Total = decimal.TryParse((string?)o.Element("total"), out decimal total) ? total : 0m,
			//						 }).ToArray()
			//				}).ToList(); //XML Data
